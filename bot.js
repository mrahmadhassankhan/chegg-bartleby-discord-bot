/*I Write this simple script in Java Script this will work both for chegg and for bartleby for bartleby just make few changes and this will work.
    ...
    if (message.content.startsWith(`-chegg`)) {
        ...
        if (!s.includes('https://www.chegg.com/homework-help')) {
            const errorEmbed = new Discord.MessageEmbed()
                ...
                .setTimestamp()
                .setFooter('Powered by Ahmad Hassan Khan (@ahmadhassankhan -> Github');
